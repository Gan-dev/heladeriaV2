    ...
    <>
      ...
      <main class="section-menu-card max-w-4xl mx-auto px-4 sm:px-8 pb-12">
        ...
        <nav class="flex flex-wrap items-center justify-center gap-1 border-b border-gray-200 py-4 mb-12 text-xs font-bold uppercase tracking-widest text-gray-500">
          <a href="#copas" class="px-4 py-1 hover:text-gray-900 transition-colors">🍨 Copas</a>
          <span class="text-gray-300 select-none">|</span>
          <a href="#icecream" class="px-4 py-1 hover:text-gray-900 transition-colors">🍦 Helados</a>
          <span class="text-gray-300 select-none">|</span>
          <a href="#granizado" class="px-4 py-1 hover:text-gray-900 transition-colors">🧊 Granizados</a>
        </nav>
        ...
        <section class="section-anchor mb-16" id="copas">
          <div class="flex items-center gap-4 mb-10">
            ...
            <div class="text-center px-2">
              <p class="text-xs uppercase tracking-widest text-gray-400 mb-0.5">Nuestras</p>
              <h2 class="text-2xl sm:text-3xl font-bold tracking-wide">Copas</h2>
            </div>
            <div class="flex-1 h-px bg-gray-300" />
          </div>
        ...
        <section class="section-anchor mb-16" id="icecream">
          <div class="flex items-center gap-4 mb-10">
            <div class="flex-1 h-px bg-gray-300" />
            <div class="text-center px-2">
              <p class="text-xs uppercase tracking-widest text-gray-400 mb-0.5">Elaborados a diario</p>
              <h2 class="text-2xl sm:text-3xl font-bold tracking-wide">Helados</h2>
            </div>
            <div class="flex-1 h-px bg-gray-300" />
          </div>
          ...
          <div class="mb-10 max-w-2xl mx-auto border-2 border-gray-800">
            <div class="bg-gray-800 px-6 py-2.5 text-center">
              <p class="text-white text-xs font-bold uppercase tracking-widest">Para Llevar · Hasta 3 sabores</p>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-200">
              {ices.precios.map((grupo: PrecioGrupo) => (
                <div key={grupo.title} class="px-6 py-5">
                  <p class="text-center text-xs uppercase tracking-widest text-gray-400 mb-4">{grupo.title}</p>
                  <ul class="space-y-3">
                    {grupo.items.map((p: PrecioItem) => (
                      <li key={p.name} class="flex items-end gap-1">
                        <span class="text-gray-700 text-sm pb-0.5">{p.name}</span>
                        <span class="flex-1 border-b border-dotted border-gray-300 mb-1" />
                        <span class="text-gray-900 font-bold tabular-nums pb-0.5">{p.price}</span>
                      </li>
                    ))}
                  </ul>
                </div>
        ...
        <section class="section-anchor mb-4" id="granizado">
          <div class="flex items-center gap-4 mb-10">
            <div class="flex-1 h-px bg-gray-300" />
            <div class="text-center px-2">
              <p class="text-xs uppercase tracking-widest text-gray-400 mb-0.5">Refrescantes</p>
              <h2 class="text-2xl sm:text-3xl font-bold tracking-wide">Granizados & Bebidas</h2>
            </div>
            <div class="flex-1 h-px bg-gray-300" />
          </div>
          ...
          <div class="mb-10 max-w-2xl mx-auto border-2 border-gray-800">
            <div class="bg-gray-800 px-6 py-2.5 text-center">
              <p class="text-white text-xs font-bold uppercase tracking-widest">Tarifas</p>
            </div>
